...
if choice==0:
    ...
    output_dir = f'/users8/hzyang/proj/c3-master/Self-Training-MRC-master/experiments/race/topk-evidence/combine/pool/v1.0'
    ...
    output_dir = f'/users8/hzyang/proj/c3-master/Self-Training-MRC-master/experiments/'+task_name+'_'+str(num_train_epochs)+'/topk-evidence/combine/pool/v1.0_'
...
cmd = f'CUDA_VISIBLE_DEVICES=2,3,4 /users8/hzyang/miniconda3/envs/python36/bin/python /users8/hzyang/proj/c3-master/Self-Training-MRC-master/main_multi_choice_top_k_evidence.py  ' \
